                ...
                <form action="{{ route('admin.deposit.gateway.update', $gateway->code) }}" method="POST"
                    ...
                    <div class="card-body">
                        <div class="payment-method-item">
                                ...
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview"
                                             style="background-image: url('{{ getImage(imagePath()['gateway']['path'].'/'. $gateway->image,'800x800') }}')"></div>
                                    </div>
                                ...
                                <div class="content">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="input-group d-flex flex-wrap justify-content-end has_append width-375">
                                            <select class="newCurrencyVal custom-select">
                            ...
                            @endif
                            <div class="payment-method-body mt-2">
                                <h4 class="mb-3">@lang('Global Setting for') {{ $gateway->name }}</h4>
                                <div class="row">
                                ...
                                <div class="payment-method-item child--item">
                                    <div class="payment-method-header d-flex flex-wrap">
                                        ...
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview"
                                                     style="background-image: url('{{getImage(imagePath()['gateway']['path'].'/'. $gateway_currency->image,'800x800')}}')"></div>
                                            </div>
                                            <div class="avatar-edit">
                                                <input type="file" name="currency[{{ $currency_idx }}][image]"
                                                       id="image{{ $currency_idx }}" class="profilePicUpload"
                                                       accept=".png, .jpg, .jpeg"/>
                                                <label for="image{{ $currency_idx }}" class="bg-primary"><i
                                        ...
                                        <div class="content">
                                            <div class="d-flex justify-content-between">
                                                <div class="form-group">
                                                    <h4 class="mb-3">{{ $gateway->name }}
                                                        - {{$gateway_currency->currency}}</h4>
                                                    <input type="text" class="form-control"
                                                           placeholder="Name for Gateway"
                                                           name="currency[{{ $currency_idx }}][name]"
                                                           value="{{ $gateway_currency->name }}" required/>
                                                </div>
                                                <div class="remove-btn">
                                                    <button type="button" class="btn btn--danger deleteBtn" data-id="{{ $gateway_currency->id }}"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        <label class="w-100">@lang('Minimum Amount')</label>
                                                        ...
                                                        <label class="w-100">@lang('Maximum Amount')</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text">{{ $general->cur_text }}</span>
                                                            </div>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                                <div class="card border--primary mt-2">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <label class="w-100">@lang('Fixed Charge')</label>
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                        ...
                                                        <label class="w-100">@lang('Percent Charge')</label>
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <input type="text" name="currency[{{ $currency_idx }}][currency]" class="form-control " value="{{ $gateway_currency->currency }}"
                                                                           readonly/>
                                                                </div>
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text">1 {{ $general->cur_text }}
                                                                    =
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="input-group-append">
                                                                <div class="input-group-text">
                                                                    <span class="currency_symbol">{{ $gateway_currency->baseSymbol() }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="payment-method-item child--item newMethodCurrency d-none">
                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview"
                                             style="background-image: url('{{getImage(imagePath()['gateway']['path'],'800x800')}}')">

                                        </div>
                                    </div>
                                    <div class="avatar-edit">
                                        <input disabled type="file" accept=".png, .jpg, .jpeg" class="profilePicUpload"
                                               id="image{{ $currency_idx }}"
                                               name="currency[{{ $currency_idx }}][image]"/>
                                        <label for="image{{ $currency_idx }}" class="bg-primary"><i
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label class="w-100">@lang('Currency')</label>
                                                        <div class="input-group mb-3">
                                                            <input disabled type="text" class="form-control currencyText" name="currency[{{ $currency_idx }}][currency]" readonly/>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="w-100">@lang('Symbol')</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" name="currency[{{ $currency_idx }}][symbol]" class="form-control symbl" data-crypto="{{ $gateway->crypto }}" disabled/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text"> 1 {{ $general->cur_text }} =
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="card border--primary mt-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        @foreach($parameters->where('global', false) as $key => $param)
                                                            <div class="col-md-6">
                                                                <label class="w-100">{{ $param->title }}</label>
                                                                <div class="input-group mb-3">
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.deposit.gateway.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="la la-fw fa-backward"></i>@lang('Go Back')</a>
@endpush
