    ...
    <div class="row mb-none-30">
        ...
        <div class="col-lg-4 col-md-4 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Payment Via') {{optional($deposit->gateway)->name}}</h5>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.deposit.approve')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>
                            @lang('Are you sure to approve')
                            <span class="font-weight-bold withdraw-amount text-success"></span>
                            @lang('deposit of') <span class="font-weight-bold withdraw-user"></span>?
                        </p>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.deposit.reject')}}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                            @lang('Are you sure to') <span class="font-weight-bold">@lang('reject')</span>
                            <span class="font-weight-bold withdraw-amount text-success"></span>
                            @lang('deposit of')
